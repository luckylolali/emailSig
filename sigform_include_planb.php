					...
					<div class="sigform_left_contents">
						...
						<div class="sigform_row">
							<!-- <div class="sigform_5050"> -->
                                ...
                                <div class="sigform_fld">
    								<input type="text" id="sigform_organization_1" name="sigform_organization_1">
								</div>
								<!--<div class="sigform_fld">
                        ...
                        <div class="sigform_row">
    						<!-- <div class="sigform_5050"> -->
								...
								<div class="sigform_fld">
									<select id="sigform_organization" name="sigform_organization">
    									<option value="">Select One</option>
																															<option value="0">Bellarmine College of Liberal Arts</option>
					...
					<div class="sigform_left_contents">
						<div class="sigform_row">
							...
							<div class="sigform_instruction_links">	
								...
								<a href="#" data-featherlight="instructions_outlook_pc.html">Outlook (PC)</a>								
								<a href="#" data-featherlight="instructions_outlook_mac.html">Outlook (Mac)</a>								
								<a href="#" data-featherlight="instructions_apple_mail.html">Apple Mail</a>								
								<a href="#" data-featherlight="instructions_ios_mail.html">iOS Mail</a>								
								<a href="#" data-featherlight="instructions_android_gmail.html">Android Gmail App</a>								
								<a href="#" data-featherlight="instructions_android_email.html">Android Email App</a>
							</div>
...
<script type="text/javascript">
	...
	*/
	...
	function sigform_generate_signature(argument) {
		...
		if( $('#sigform_organization_1').val() != '' ){
			html = html.replace("{organization}", toTitleCase($('#sigform_organization_1').val()));
		}else{
